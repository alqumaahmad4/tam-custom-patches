...
const s1=()=>[
  ...
  tbl(
    ...
    [
      ...
      ['STABILITY_AI_API_KEY','Phase 2','Server','Stability AI for AI Designer generation'],
...
════════════════════════════════════════════════════════════════════════════ */
  ...
  tbl(
    ...
    [
      ...
      ['M9','AI Patch Designer','10–12','12d','High'],
  ...
  mBadge(9,'AI Patch Designer','10–12','High complexity · 12 days'),
  kvt([
    ['Objectives','Build the AI Designer tool at /ai-designer. Phase 1 uses static placeholder previews. Phase 2 API integration placeholders are coded but not activated.'],
    ['Deliverables','AIDesigner split-panel layout. All control inputs (prompt, product type, shape, size, colors, border, backing, style keywords). AIPromptInput with floating label, character count, suggestion chips. AIPreviewPanel with Phase 1 static preview logic. Version history strip. Compare view (split-screen with draggable divider). Save design (localStorage). Share URL generation. "Request Quote" → /quote with params pre-filled. Undo/redo (20-step history). /api/ai/generate endpoint (Phase 1: returns placeholder). Framer Motion generation loading animation.'],
    ['Dependencies','M2 (Design System), M3 (Global Layout), M7 (Quote form for "Request Quote" CTA)'],
    ...
    ['Definition of Done','AI Designer reviewed against V2 Section 6 and V4 Section 7. All interactions work on mobile.'],
...
════════════════════════════════════════════════════════════════════════════ */
  ...
  ...issueCard('098','Implement "Request Quote" → /quote with all current parameters as URL params','P0','S','[type: feature] [priority: high] [effort: S] [milestone: ai-designer]'),
  pb(),
...
════════════════════════════════════════════════════════════════════════════ */
  ...
  tbl(
    ...
    [
      ...
      ['S16','16','M8 finish + M9 start','5 MA pages, 4 accessory pages. AI Designer layout + controls.','22'],
...
════════════════════════════════════════════════════════════════════════════ */
  ...
  tbl(
    ...
    [
      ...
      ['3','Textarea','components/ui/textarea.tsx','Used in quote form and AI designer.'],
      ['4','Select','components/ui/select.tsx','Used in country selector and form.'],
      ['5','Badge / Chip','components/ui/badge.tsx','Used in cards, navigation, AI designer.'],
  ...
  tbl(
    ...
    [
      ...
      ['43','ColorSwatch / Chart','None','Product pages and AI designer.'],
      ...
      ['49','AIPromptInput','Textarea, Tooltip','AI Designer left panel.'],
      ['50','AIPreviewPanel','LoadingSkeleton','AI Designer right panel.'],
...
════════════════════════════════════════════════════════════════════════════ */
  ...
  tbl(
    ...
    [
      ...
      ['13','AI Designer','/ai-designer','M9 AI components, API','M9'],
