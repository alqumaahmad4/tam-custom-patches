...
const sA=()=>[
  ...
  tbl(
    ...
    [
      ...
      ['M9','AI Patch Designer','High','L','High','No','Phase 2 AI'],
...
════════════════════════════════════════════════════════════════════════════ */
  ...
  tbl(
    ...
    [
      ...
      ['M9: AI Designer','Complete UI, Phase 1 placeholder previews, quote link','Real AI generation (Stability AI / Ideogram API)'],
  ...
  tbl(
    ...
    [3200,1600,800,3800],
    [
      ['Real AI image generation (Stability AI / Ideogram)','Very High','XL','AI Designer (M9), API keys, rate limiting infrastructure'],
      ['AI-assisted copywriting in admin (blog, product descriptions)','Medium','M','Sanity CMS (M13), OpenAI API'],
      ['AI design quality scoring (embroidery complexity analysis)','High','L','AI Designer, image analysis API'],
      ['AI prompt improvement suggestions','Medium','M','AI Designer, GPT-4 API'],
    ]
  ),
  spacer(),
  ...
  tbl(
    ...
    [
      ...
      ['Saved AI designs synced to account','Low','S','Customer accounts, AI Designer local saves'],
...
════════════════════════════════════════════════════════════════════════════ */
  ...
  tbl(
    ...
    [
      ...
      ['Content','v0.5.0','M8, M9, M10, M11, M12','All product pages, AI Designer, gallery, industry pages, blog.','Staging (full content review)'],
...
════════════════════════════════════════════════════════════════════════════ */
  ...
  tbl(
    ...
    [
      ...
      ['M9: AI Designer','M3 complete + M7 quote link exists (can mock link)','M5, M6, M8, M10, M11, M12'],
